...
export const Mint: React.FC<IMintProps> = () => {
    return (
        <PageLayout className={CnMint()}>
            <div className={CnMint('banner')}>
                <Banner
                    image={
                        <svg
                            width="252"
                        ...
                        >
                            <rect
                                ...
                                height="248"
                                rx="12"
                                fill="url(#pattern0_banner_image)"
                            />
                            <defs>
                                <pattern
                                    id="pattern0_banner_image"
                                    patternContentUnits="objectBoundingBox"
                                    width="1"
                                    height="1"
                                >
                                    <use
                                        xlinkHref="#image0_239_1332"
                                        transform="matrix(0.00149563 0 0 0.00151976 -0.0174893 0)"
                                    />
                                </pattern>
                                <image
                                    id="image0_239_1332"
                    ...
                    banner={null}
                    title="MINTER WL PASS"
                />
            </div>

            <div className={CnMint('content')}>
